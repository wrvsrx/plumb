...
pub(crate) const TASK_CONTEXT_JS: &str = include_str!("../assets/task-context.js");
pub(crate) const TASK_TREE_JS: &str = include_str!("../assets/task-tree.js");
pub(crate) const FOCUS_JS: &str = include_str!("../assets/focus.js");
