...
mod tests {
    ...
    fn exports_managed_vdir_with_escaped_folded_crlf_events_and_stale_cleanup() {
        ...
        let source = "`meta\n  `: date\n\n    2026-07-30\n\n  `: timezone\n\n    +08:00\n\n`-{.event tasks=\"#write\"} 14:00--15:30 Review, parser; semantics with a deliberately long summary that must be folded safely\n  `note First line\n";
    ...
    fn uid_and_ical_are_independent_of_absolute_root_and_source_range() {
        ...
        let source = "`meta\n  `: date\n\n    2026-07-30\n\n  `: timezone\n\n    +08:00\n\n`-{.event} 14:00 Review\n";
        let shifted_source = format!("A preceding paragraph.\n\n{source}");
